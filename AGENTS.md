...
- Task: Work only on an approved case; make small, testable changes; record evidence.
...
3. Coding starts only after the user applies `approved-for-build` or explicitly approves the case.
